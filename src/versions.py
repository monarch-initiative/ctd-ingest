"""Upstream source version fetcher for ctd-ingest.

CTD's TSV download has a comment-style copyright header but no in-band
version line. Use HTTP Last-Modified.
"""
